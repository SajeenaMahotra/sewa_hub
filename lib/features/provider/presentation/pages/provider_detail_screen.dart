...
class _ProviderDetailScreenState extends ConsumerState<ProviderDetailScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(providerViewModelProvider.notifier)
                      ...
                      children: [
                        Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 2),
                            Text('Charged per hour of service',
                                style: TextStyle(
                                    fontSize: 12,
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: provider.ratingCount > 0   // ← fixed
                                    ? const Color(0xFFFFF7ED)
                                    : const Color(0xFFF1F5F9),
                                borderRadius: BorderRadius.circular(20),
                              ),
                              child: Text(
                                provider.ratingCount == 0           // ← fixed
                                    ? 'No reviews'
                        ...
                        if (provider.ratingCount == 0) ...[          // ← fixed
  ...
  Widget _initialsWidget(String? name) {
    return Center(
      child: Text(_initials(name),
          style: const TextStyle(
              fontSize: 26, fontWeight: FontWeight.w800, color: _orange)),
    );
  }
}
...
class _ContactTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Padding(
        padding: EdgeInsets.fromLTRB(20, isFirst ? 18 : 14, 20, isLast ? 18 : 14),
        child: Row(children: [
          Container(
            width: 44, height: 44,
            decoration: BoxDecoration(
